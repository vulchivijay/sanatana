...
export async function generateMetadata(props: any) {
  ...
  const meta = getMeta('scriptures_vedas_yajurveda', undefined, locale) || {};
  return {
    title: meta.title,
  ...
  return (
    <>
      ...
      <main className="content-wrapper md page-space-xl">
        <div>
          <Breadcrumbs items={[{ labelKey: 'nav.home', href: '/' }, { labelKey: 'nav.vedas', href: '/vedas' }, { labelKey: 'yajurveda.title' }]} locale={locale} />
          <h2>{t('yajurveda.title', locale)}</h2>
