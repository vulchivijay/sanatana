    ...
    <>
      <main className="content-wrapper md page-space-xl">
        <div>
          ...
          <h2>{S('puranas.bhagavata.title', locale)}</h2>
          <p>{S('puranas.bhagavata.summary', locale)}</p>
          <section>
            <h3>{S('puranas.bhagavata.title', locale)}</h3>
            <p>{S('puranas.bhagavata.content', locale)}</p>
          </section>
        </div>
      </main>
    </>
