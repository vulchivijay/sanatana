  ...
  return (
    <section className="bg-white about-shiva">
      <div className="content-wrapper text-left">
        <div className="max-w-5xl text-2xl/10! md:text-3xl/12! font-semibold! multi-text-color">
      ...
      <div className="content-wrapper">
        <div className="flex flex-col md:flex-row items-start justify-between history">
          <div className="w-full md:w-1/3 md:text-center">
            <b className="text-3xl md:text-3xl">{t('home.stat1', locale || DEFAULT_LOCALE)}</b>
            <p>
          ...
          <div className="w-full md:w-1/3 md:text-center">
            <b className="text-3xl md:text-3xl">{t('home.stat2', locale || DEFAULT_LOCALE)}</b>
            <p>
          ...
          <div className="w-full md:w-1/3 md:text-center">
            <b className="text-3xl md:text-3xl">{t('home.stat3', locale || DEFAULT_LOCALE)}</b>
            <p>
